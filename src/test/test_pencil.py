...
def test_simple_pencil_returns_set(board):
...
def test_simple_pencil_nonempty(board):
...
def test_simple_pencil_excludes_row_values(board):
...
def test_simple_pencil_excludes_col_values(board):
...
def test_simple_pencil_excludes_block_values(board):
...
def test_update_pencil_fills_empty_cells(board):
...
def test_update_pencil_skips_filled_cells(board):
